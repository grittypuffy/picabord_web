...
function DarkVeil({ hueShift = 0, noiseIntensity = 0, scanlineIntensity = 0, speed = 0.5, scanlineFrequency = 0, warpAmount = 0, resolutionScale = 0.75, adaptToTheme = true }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        try {
            ...
            const resize = ()=>{
                ...
                const w = rect.width || parent.clientWidth || window.innerWidth;
                const h = rect.height || parent.clientHeight || window.innerHeight;
                if (w > 0 && h > 0) {
...
//# sourceMappingURL=_965d40f1._.js.map